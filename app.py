...
st.sidebar.text("Submitted to: IDEAS-TIH, ISI Kolkata")
st.sidebar.text("As part of the Student Internship Program July - 2024")
...
st.sidebar.text("Supervisors: Dr. Sandip Bhattacharyya")
